// Custom JavaScript for Semana 2 - Requerimientos y Elicitación de Software
...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Presentación Semana 2 - Requerimientos y Elicitación de Software cargada');
        ...
        <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
            ...
            <div style="background: white; padding: 2rem; border-radius: 10px; max-width: 500px;">
                ...
                <ul style="text-align: left;">
                    ...
                    <li><strong><i class="fas fa-info-circle"></i> (icono flotante):</strong> Mostrar guía de ingeniería de software</li>
...
// Show requirements reference guide
function showRequirementsReference() {
    const requirementsGuideContent = `
        <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
                    background: rgba(0,0,0,0.8); z-index: 9999; display: flex; 
                    align-items: center; justify-content: center;" id="requirementsOverlay">
            <div style="background: white; padding: 2rem; border-radius: 10px; max-width: 700px; max-height: 80vh; overflow-y: auto;">
                <h3 style="color: var(--uide-primary); margin-bottom: 1.5rem;">
                    <i class="fas fa-cogs"></i> Guía Rápida de Ingeniería de Software
                </h3>
                
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; text-align: left;">
                    <div>
                        <h4 style="color: #28a745; margin-bottom: 0.8rem;">
                            <i class="fas fa-gear"></i> Requerimientos Funcionales
                        </h4>
                        <p style="font-size: 0.9em; margin-bottom: 0.5rem;"><strong>Qué hace el sistema:</strong></p>
                        <ul style="font-size: 0.8em; margin: 0; padding-left: 1.2rem;">
                            <li>Operaciones específicas</li>
                            <li>Funcionalidades principales</li>
                            <li>Casos de uso del sistema</li>
                            <li>Interacciones con usuarios</li>
                        </ul>
                    </div>
                    
                    <div>
                        <h4 style="color: #910048; margin-bottom: 0.8rem;">
                            <i class="fas fa-shield-alt"></i> Requerimientos No Funcionales
                        </h4>
                        <p style="font-size: 0.9em; margin-bottom: 0.5rem;"><strong>Cómo debe funcionar:</strong></p>
                        <ul style="font-size: 0.8em; margin: 0; padding-left: 1.2rem;">
                            <li>Rendimiento y velocidad</li>
                            <li>Seguridad y privacidad</li>
                            <li>Usabilidad y accesibilidad</li>
                            <li>Confiabilidad y escalabilidad</li>
                        </ul>
                    </div>
                </div>
                
                <div style="margin: 1.5rem 0; padding: 1rem; background: #f8f9fa; border-radius: 8px;">
                    <h4 style="color: #23356E; margin-bottom: 0.8rem;">
                        <i class="fas fa-comments"></i> Técnicas de Elicitación
                    </h4>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 0.5rem; font-size: 0.8em;">
                        <span><i class="fas fa-microphone"></i> Entrevistas</span>
                        <span><i class="fas fa-users"></i> Talleres</span>
                        <span><i class="fas fa-eye"></i> Observación</span>
                        <span><i class="fas fa-clipboard-list"></i> Cuestionarios</span>
                        <span><i class="fas fa-lightbulb"></i> Lluvia de ideas</span>
                        <span><i class="fas fa-cube"></i> Prototipos</span>
                    </div>
                </div>
                
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    <div style="padding: 0.8rem; background: rgba(40, 167, 69, 0.1); border-radius: 6px;">
                        <h5 style="color: #28a745; margin: 0 0 0.5rem 0;">
                            <i class="fas fa-file-alt"></i> SRS Tradicional
                        </h5>
                        <p style="font-size: 0.8em; margin: 0;">Documento formal completo con especificaciones detalladas</p>
                    </div>
                    <div style="padding: 0.8rem; background: rgba(35, 53, 110, 0.1); border-radius: 6px;">
                        <h5 style="color: #23356E; margin: 0 0 0.5rem 0;">
                            <i class="fas fa-tasks"></i> Backlog Ágil
                        </h5>
                        <p style="font-size: 0.8em; margin: 0;">User Stories priorizadas que evolucionan con el proyecto</p>
                    </div>
                </div>
                
                <button onclick="closeOverlay('requirementsOverlay')" 
                        style="width: 100%; margin-top: 1rem; padding: 0.8rem 1rem; 
                               background: var(--uide-primary); color: white; border: none; 
                               border-radius: 8px; cursor: pointer; font-size: 0.9em;
                               transition: all 0.2s ease;"
                        onmouseover="this.style.background='var(--uide-secondary)';"
                        onmouseout="this.style.background='var(--uide-primary)';">
                    <i class="fas fa-check"></i> Cerrar Guía
                </button>
            </div>
        </div>
    `;

    document.body.insertAdjacentHTML('beforeend', requirementsGuideContent);
}
